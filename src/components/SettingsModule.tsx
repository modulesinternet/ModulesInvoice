        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-[#E5E7EB] shadow-sm space-y-4">
            <h3 className="font-bold text-slate-900 text-sm font-display border-b border-[#E5E7EB] pb-3 flex items-center gap-2">
              ...
              <span>Digital Corporate Stamp Marks</span>
            </h3>

            <div className="space-y-2">
              <label className="text-[10px] font-bold text-slate-400 uppercase">Signature Image (HTTPS Link Only)</label>
              <input 
                type="text"
                required
                value={signatureUrl}
                ...
                className="w-full text-xs p-2.5 border border-slate-200 rounded-xl font-mono"
              />
              <div className="p-4 bg-slate-50 border border-[#E5E7EB] rounded-xl flex items-center justify-center">
                <img src={signatureUrl} className="h-12 opacity-85 object-contain" alt="Stamps preview" />
              </div>
            </div>
          </div>
